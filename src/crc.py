# -*- coding: utf-8 -*-
"""
Created on Tue Nov 28 13:45:55 2017
...
''''
test = crc16()
arry = [0x68 ,0x06 ,0x04 ,0x04 ,0x08 ,0x00 ,0x01, 0x03, 0x03, 0x01 ,0x02, 0x01, 0xD4, 0xEE]
test.addcheck(arry)
for jj in range(0,len(arry)):
    print('%x '%arry[jj])



#arr = [0x00, 0x10, 0x00 ,0x02, 0x00, 0x01, 0x02, 0x00, 0x88]
arr = [0x01, 0x03 ,0x03 ,0x01 ,0x02 ,0x01]
x1 = 0xff
x2 = 0xff
x3 = 0xffff
x3 = test.createcrc(arr)
print(type(x1))
x1 &= x3
x2 &= (x3>>8)
print('%x,%x'%(x3,(x3>>8)&0xff))
print('====')
'''
